...
int _countMatchingProviders({
  ...
  return providers.where((p) {
    ...
    final matchesCity =
        filter.selectedCities.isEmpty || filter.selectedCities.contains(p.city);
                ...
                child: ListView(
                  ...
                  children: [
                    FilterChipGroup(
                      ...
                      onToggle:
                          (v) => _toggle(v, _draft.selectedCountries, (list) {
                            final validCities =
                                mockProviders
                    ...
                    FilterChipGroup(
                      ...
                      onToggle:
                          (v) => _toggle(
                            ...
                            _draft.selectedCities,
                            (list) =>
                                _draft = _draft.copyWith(selectedCities: list),
                          ),
                    ),
                    SizedBox(height: ext.spacingMd),
                    FilterChipGroup(
